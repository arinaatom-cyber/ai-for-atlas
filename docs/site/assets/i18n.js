...
(function () {
  ...
  const PAGE = {
    ru: {
      ...
      agents_lead: "Discovery использует несколько агентов: скан репозиториев, ИИ-чтение абстрактов, контроль качества по правилам и оценку строк.",
      ...
      tech_step4: "4. Контроль материала + data availability gate (protein-level table в репозитории).",
    ...
    en: {
      ...
      agents_lead: "Discovery uses repository scan, abstract AI reader, rule-based quality control, and row evaluation agents.",
      ...
      tech_step3: "3. Hard filters: organism, TMT >6 plex, tissue/cell line, reject plasma-only.",
      tech_step4: "4. Material check + data availability gate (protein-level table in repository).",
