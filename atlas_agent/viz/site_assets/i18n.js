(function () {
  ...
  const SHARED = {
    ...
    th_similar_hint: {
      ru: "Косинусное сходство названия/абстракта с проектом в каталоге TMT ATLAS",
      en: "Cosine similarity of title/abstract to a project already in the TMT ATLAS catalog",
    },
  ...
  const PAGE = {
    ru: {
      ...
      filter_all: "Все",
      legend_candidate: "прошёл правила, можно смотреть таблицу",
      legend_review: "нужна ручная проверка файлов или дизайна",
      legend_watch: "следить по литературе, ID репозитория нет",
      ...
      lit_exclusion_engine: "Исключено до LLM",
      lit_llm_errors: "Ошибки LLM",
      ...
      guide_filters_title: "Поиск",
      guide_filters_search: "Поле над таблицей ищет по ID, названию, PMID, описанию и тексту анализа.",
    ...
    en: {
      ...
      filter_all: "All",
      legend_candidate: "passed the rules — protein table worth reviewing",
      legend_review: "needs a manual file or design check",
      legend_watch: "literature watch, no repository ID",
      ...
      lit_exclusion_engine: "Excluded before LLM",
      lit_llm_errors: "LLM errors",
      ...
      guide_filters_title: "Search",
      guide_filters_search: "The search box above the table matches ID, title, PMID, description, and analysis text.",
