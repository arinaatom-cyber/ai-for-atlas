# Stats plan for PXD011456
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: pnas.1819851116.sd01
# mat <- read_protein_matrix("tmt-projects/Projects/PXD011456/...")
...
# norm_in_sheet: Internal channel normalization to 126 (blank
