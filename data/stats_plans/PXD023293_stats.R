# Stats plan for PXD023293
# Design: paired | Patient level: unknown
library(limma)

# 1) Load protein matrix from Result File: Supplementary_Table_2
# mat <- read_protein_matrix("tmt-projects/Projects/PXD023293/...")
...
# norm_in_sheet: log2 transformation + quantile normalization (LIMMA pipeline)
