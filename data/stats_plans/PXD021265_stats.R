# Stats plan for PXD021265
# Design: paired | Patient level: patient
library(limma)

# 1) Load protein matrix from Result File: proteinGroups_global_patients
# mat <- read_protein_matrix("tmt-projects/Projects/PXD021265/...")
...
# norm_in_sheet: median-MAD normalization (log2 ratios relapse/diagnosis)
