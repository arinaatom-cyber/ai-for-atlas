# Stats plan for PDC000360
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000360.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000360/...")
...
# norm_in_sheet: CDAP; FFPE-adjusted norm; log2 ratio
