# Stats plan for PXD032355
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: PXD032355_Proteins_33_sheets
# mat <- read_protein_matrix("tmt-projects/Projects/PXD032355/...")
...
# norm_in_sheet: not explicitly reported in PRIDE dataset description
