# Stats plan for PXD019544
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: recovery_rep1_np40_SDS_light
# mat <- read_protein_matrix("tmt-projects/Projects/PXD019544/...")
...
# norm_in_sheet: Pooled internal standard (IRS) + ComBat batch correction
