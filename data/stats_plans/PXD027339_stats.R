# Stats plan for PXD027339
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: HGCC_GBM_stem_cell_lines_TMT16_HiRIEF_IPG3-10_proteins_table_
# mat <- read_protein_matrix("tmt-projects/Projects/PXD027339/...")
...
# norm_in_sheet: Median of PSM ratios (OpenMS IsobaricAnalyzer)
