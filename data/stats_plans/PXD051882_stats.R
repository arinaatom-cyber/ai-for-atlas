# Stats plan for PXD051882
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: 1-s2
# mat <- read_protein_matrix("tmt-projects/Projects/PXD051882/...")
...
# norm_in_sheet: Reference channel + within-channel normalization
