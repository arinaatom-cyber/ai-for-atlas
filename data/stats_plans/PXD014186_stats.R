# Stats plan for PXD014186
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: ProteinGroups_TPP
# mat <- read_protein_matrix("tmt-projects/Projects/PXD014186/...")
...
# norm_in_sheet: internal TPP normalization
