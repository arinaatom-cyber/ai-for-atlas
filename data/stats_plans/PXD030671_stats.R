# Stats plan for PXD030671
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: Table S4
# mat <- read_protein_matrix("tmt-projects/Projects/PXD030671/...")
...
# norm_in_sheet: Reporter ion MS2 quantification; isotopic correction; Sample Loading (SL) normalization (intra-run)
