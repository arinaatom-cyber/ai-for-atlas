# Stats plan for MSV000085836
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: sn_non_normalized_v1.1
# mat <- read_protein_matrix("tmt-projects/Projects/MSV000085836/...")
...
# norm_in_sheet: Ratio-to-bridge normalization Summed S/N equalization (>200); log2-transformation; bridge ratio subt
