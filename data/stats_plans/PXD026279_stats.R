# Stats plan for PXD026279
# Design: paired | Patient level: unknown
library(limma)

# 1) Load protein matrix from Result File: Supplementary Table S3_Proteins list_111721
# mat <- read_protein_matrix("tmt-projects/Projects/PXD026279/...")
...
# norm_in_sheet: Relative TMT reporter ion quantification; paired two-tailed t-test; ≥2-fold change threshold; Perseu
