# Stats plan for PXD043580
# Design: case_control | Patient level: patient
library(limma)

# 1) Load protein matrix from Result File: 43018_2024_784_MOESM2_ESM
# mat <- read_protein_matrix("tmt-projects/Projects/PXD043580/...")
...
# norm_in_sheet: Median normalization (TMT), LFQ normalization (MaxLFQ/DIANN)
