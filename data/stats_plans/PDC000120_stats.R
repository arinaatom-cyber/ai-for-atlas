# Stats plan for PDC000120
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000120.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000120/...")
...
# norm_in_sheet: CDAP; median norm; log2 ratio to ref
