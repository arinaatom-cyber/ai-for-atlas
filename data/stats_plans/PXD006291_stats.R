# Stats plan for PXD006291
# Design: cell_line | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: UUtissues_HiRIEFII_protein_table_proteincentric
# mat <- read_protein_matrix("tmt-projects/Projects/PXD006291/...")
...
# norm_in_sheet: pooled (internal standard) ratio normalization at protein level
