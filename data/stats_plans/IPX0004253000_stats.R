# Stats plan for IPX0004253000
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: 13046_2022_2445_MOESM9_ESM
# mat <- read_protein_matrix("tmt-projects/Projects/IPX0004253000/...")
...
# norm_in_sheet: Not explicitly stated; low-abundance proteins removed, proteins missing >20% removed, KNN imputation
