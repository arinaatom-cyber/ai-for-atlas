# Stats plan for PXD006895
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: totallysate_protein_table_symbolcentric
# mat <- read_protein_matrix("tmt-projects/Projects/PXD006895/...")
...
# norm_in_sheet: Normalized to sample median
