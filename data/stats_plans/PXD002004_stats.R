# Stats plan for PXD002004
# Design: case_control | Patient level: unknown
library(limma)

# 1) Load protein matrix from Result File: supp_RA117.000539_134638_0_supp_38938_p0ykzb
# mat <- read_protein_matrix("tmt-projects/Projects/PXD002004/...")
...
# norm_in_sheet: SPIQuE (weighted PSM contributions); Regulation score (Rs); Batch effect reduction via bridging cont
