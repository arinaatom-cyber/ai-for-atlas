# Stats plan for PXD029216_BULK
# Design: other | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: PXD029216_BULK.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PXD029216_BULK/...")
...
# norm_in_sheet: Reporter ion intensity normalization
