# Stats plan for PDC000402
# Design: other | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000402.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000402/...")
...
# norm_in_sheet: CDAP; median norm; log2 ratio to pooled ref
