# Stats plan for PXD039319
# Design: other | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: proteinGroups
# mat <- read_protein_matrix("tmt-projects/Projects/PXD039319/...")
...
# norm_in_sheet: reporter intensity correction (isotope impurity corrected); log2 transform; median normalization; ba
