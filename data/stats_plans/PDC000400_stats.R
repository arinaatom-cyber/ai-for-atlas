# Stats plan for PDC000400
# Design: other | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000400.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000400/...")
...
# 5) Test: wilcoxon_or_limma_small_n
