# Stats plan for PXD022733
# Design: paired | Patient level: patient
library(limma)

# 1) Load protein matrix from Result File: Supplementary Table 1
# mat <- read_protein_matrix("tmt-projects/Projects/PXD022733/...")
...
# norm_in_sheet: Internal Reference Scaling protein level normalization
