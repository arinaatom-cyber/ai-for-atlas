# Stats plan for PXD016563
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: 157418_1_supp_477733_q5x4r2
# mat <- read_protein_matrix("tmt-projects/Projects/PXD016563/...")
...
# norm_in_sheet: Median normalization + batch normalization
