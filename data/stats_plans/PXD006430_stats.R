# Stats plan for PXD006430
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: shTRAP_TMT10_IPG3-10_psms
# mat <- read_protein_matrix("tmt-projects/Projects/PXD006430/...")
...
# norm_in_sheet: median across channels (protein level)
