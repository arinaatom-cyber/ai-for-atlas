# Stats plan for PXD017852
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: NIHMS1592411-supplement-1592411_SuppTable1
# mat <- read_protein_matrix("tmt-projects/Projects/PXD017852/...")
...
# norm_in_sheet: Channel-wise total reporter signal normalization
