# Stats plan for PDC000342
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000342.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000342/...")
...
# norm_in_sheet: N/A — no processed mass spectra in PDC
