# Stats plan for PXD030818
# Design: other | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: Total_proteome_data
# mat <- read_protein_matrix("tmt-projects/Projects/PXD030818/...")
...
# norm_in_sheet: Reporter ion intensity normalization (within batch)
