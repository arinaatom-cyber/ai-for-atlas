# Stats plan for PXD036226
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: 41467_2023_39486_MOESM4_ES
# mat <- read_protein_matrix("tmt-projects/Projects/PXD036226/...")
...
# norm_in_sheet: Reference-based normalisation (sample/reference), log2 transform, median centering, scaling
