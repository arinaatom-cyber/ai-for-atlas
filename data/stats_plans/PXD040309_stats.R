# Stats plan for PXD040309
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: EMS209392-supplement-Table_S6
# mat <- read_protein_matrix("tmt-projects/Projects/PXD040309/...")
...
# norm_in_sheet: Median normalization + limma
