# Stats plan for PXD010425
# Design: paired | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: Differential_expression_analyses
# mat <- read_protein_matrix("tmt-projects/Projects/PXD010425/...")
...
# norm_in_sheet: MSnbase (R), reporter ion–based normalization
