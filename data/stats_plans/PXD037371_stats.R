# Stats plan for PXD037371
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: pmic.202200432&file=pmic13638-sup-0001-SuppMat1
# mat <- read_protein_matrix("tmt-projects/Projects/PXD037371/...")
...
# norm_in_sheet: Median normalization (MaxQuant, protein ratio median)
