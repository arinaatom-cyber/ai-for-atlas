# Stats plan for PDC000234
# Design: paired | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000234.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000234/...")
...
# norm_in_sheet: CDAP; median norm; log2 ratio to CompRef
