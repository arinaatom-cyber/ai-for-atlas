# Stats plan for PDC000477
# Design: other | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000477.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000477/...")
...
# norm_in_sheet: CDAP pipeline; median normalization; log2 ratio to pooled ref
