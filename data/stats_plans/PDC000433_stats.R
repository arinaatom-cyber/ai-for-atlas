# Stats plan for PDC000433
# Design: other | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: nan
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000433/...")
...
# norm_in_sheet: N/A — no processed data in PDC
