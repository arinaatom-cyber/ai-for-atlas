# Stats plan for PXD012845
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: proteinGroups.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PXD012845/...")
...
# norm_in_sheet: TMT reference channel normalization (126) followed by per-plex median centering
