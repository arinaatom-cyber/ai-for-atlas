# Stats plan for PXD034370
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: Fig4_proteinGroups
# mat <- read_protein_matrix("tmt-projects/Projects/PXD034370/...")
...
# norm_in_sheet: PSM-level weighted ratio normalization; log2 transformation; column and row median subtraction
