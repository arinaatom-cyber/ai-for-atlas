# Stats plan for PXD010846
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: total_proteome_baseline
# mat <- read_protein_matrix("tmt-projects/Projects/PXD010846/...")
...
# norm_in_sheet: Sum-normalization + median scaling (per set); relative to Day 0
