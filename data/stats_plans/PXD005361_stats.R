# Stats plan for PXD005361
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: NIHMS884016-supplement-SFigure1
# mat <- read_protein_matrix("tmt-projects/Projects/PXD005361/...")
...
# norm_in_sheet: Summed reporter ion intensity normalization per channel
