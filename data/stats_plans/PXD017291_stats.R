# Stats plan for PXD017291
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: recovery_rep1_np40_light
# mat <- read_protein_matrix("tmt-projects/Projects/PXD017291/...")
...
# norm_in_sheet: Within-TMT relative FC normalized to reference_label=129L
