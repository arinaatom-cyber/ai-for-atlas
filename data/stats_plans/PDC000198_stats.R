# Stats plan for PDC000198
# Design: paired | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000198.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000198/...")
...
# norm_in_sheet: Median norm; log2 ratio to pooled ref
