# Stats plan for PXD029320
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: INTENSITIES_all_F
# mat <- read_protein_matrix("tmt-projects/Projects/PXD029320/...")
...
# norm_in_sheet: Reporter ion intensity normalization across TMT channels; carrier-based normalization
