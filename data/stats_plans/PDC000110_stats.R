# Stats plan for PDC000110
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: result_PDC000110.xlsx
# mat <- read_protein_matrix("tmt-projects/Projects/PDC000110/...")
...
# norm_in_sheet: Universal pooled reference normalization; CDAP harmonization; log2 relative abundance ratios
