# Stats plan for MSV000090700
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: mmc3
# mat <- read_protein_matrix("tmt-projects/Projects/MSV000090700/...")
...
# norm_in_sheet: Reference channel normalization (within plex) + global scaling (MSstatsTMT)
