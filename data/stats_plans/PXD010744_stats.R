# Stats plan for PXD010744
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: 12014_2019_9236_MOESM2_ESM
# mat <- read_protein_matrix("tmt-projects/Projects/PXD010744/...")
...
# norm_in_sheet: Protein ratios against the internal standard (TMT126 channel) were computed and then log2-transforme
