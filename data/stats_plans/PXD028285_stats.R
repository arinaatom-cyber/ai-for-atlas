# Stats plan for PXD028285
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: noad064_suppl_supplementary_table_s4
# mat <- read_protein_matrix("tmt-projects/Projects/PXD028285/...")
