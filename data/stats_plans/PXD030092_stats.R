# Stats plan for PXD030092
# Design: paired | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: LSA-2022-01680_TableS2
# mat <- read_protein_matrix("tmt-projects/Projects/PXD030092/...")
...
# norm_in_sheet: Normalization to reference (linker) channel; log2 transformation
