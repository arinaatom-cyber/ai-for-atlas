# Stats plan for PXD050642
# Design: case_control | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: PXD050642
# mat <- read_protein_matrix("tmt-projects/Projects/PXD050642/...")
...
# norm_in_sheet: Reporter ion intensity-based protein normalization (not fully specified)
