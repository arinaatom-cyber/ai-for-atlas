# Stats plan for PXD020586
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: integrated_Proteins_FULL
# mat <- read_protein_matrix("tmt-projects/Projects/PXD020586/...")
...
# norm_in_sheet: SCeptre; bridge-channel normalization; log-normalization; batch correction across plates
