# Stats plan for PXD017025
# Design: cell_line | Patient level: cell_line
library(limma)

# 1) Load protein matrix from Result File: mmc2
# mat <- read_protein_matrix("tmt-projects/Projects/PXD017025/...")
...
# norm_in_sheet: Equal total protein normalization per TMT channel; inter-set batch correction using pooled reference
