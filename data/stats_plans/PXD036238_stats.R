# Stats plan for PXD036238
# Design: paired | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: Supplementary_Table S2
# mat <- read_protein_matrix("tmt-projects/Projects/PXD036238/...")
...
# norm_in_sheet: Bridge-based normalization across TMT experiments
