# Stats plan for PXD027341
# Design: other | Patient level: sample
library(limma)

# 1) Load protein matrix from Result File: GBM_tumour_tissue__TMT10plex_HiRIEF_3-10_proteins_table
# mat <- read_protein_matrix("tmt-projects/Projects/PXD027341/...")
